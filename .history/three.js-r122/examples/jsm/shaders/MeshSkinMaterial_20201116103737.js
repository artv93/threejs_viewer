...
void main() {
  ...
  #include <lights_fragment_end>
	...
	#endif
	gl_FragColor = vec4(texture2D(thicknessMap, vUv * thicknessRepeat).r, 0, 0, 1);// vec4( outgoingLight, diffuseColor.a );
...
var MeshSkinMaterial = function (parameters) {
  ...
  this.uniforms = Object.assign({},
    THREE.ShaderLib.physical.uniforms,
    {
      ...
      thicknessRepeat: new THREE.Uniform(parameters.thicknessRepeat || new THREE.Vector2()), //{ value: parameters.thicknessRepeat || new THREE.Vector2() },
      thicknessPower: new THREE.Uniform(20), //{ value: 200 },
      thicknessScale: new THREE.Uniform(4), //{ value: 40 },
      thicknessDistortion: new THREE.Uniform(0.185), //{ value: 0.185 },
      thicknessAmbient: new THREE.Uniform(0.5), //{ value: 0.5 },
